import { tasksActions, tasksReducer, TasksReducerType } from 'state'
...
test('setTasks', () => {
	 ...
	 const endState = tasksReducer(startState, tasksActions.setTasks({ todolistId: todolistID, tasksFromAPI }))
